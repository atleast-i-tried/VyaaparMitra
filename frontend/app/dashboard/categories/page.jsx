...
import { getColumns } from "./features/columns"; // rename import to avoid conflict
...
const Page = () => {
  ...
  const buildQuery = () => {
    ...
    if (filters.name) query.set("filters[name][$containsi]", filters.name);
  ...
  // use imported getColumns function to get table columns
